...
from fairwaymarket.items import DepartItem, GoodItem, ImageItem
...
class FairmarketspiderSpider(scrapy.Spider):
    name = 'fairmarketspider'
    allowed_domains = ['shop.fairwaymarket.com']
    start_urls = ['http://shop.fairwaymarket.com/']
    ...
    def parse_login(self, response):
        ...
        yield scrapy.FormRequest(
            url='https://shop.fairwaymarket.com/accounts/login',
            formdata={
    ...
    def parse(self, response):
        ...
        ########################################################################
        # depart_url = 'https://shop.fairwaymarket.com/v3/retailers/53/containers'
        ...
        for row in depart_list:
            ...
            goods_url = 'https://shop.fairwaymarket.com/v3/retailers/53/module_data/aisle_%s_%s?aisle_id=%s&department_id=%s&source=web&tracking.items_per_row=7&per=100' % (depart_no,depart_sub_no,depart_no,depart_sub_no)
    ...
    def parse_goods(self, response):
        ...
        try:
            ...
            next_goods_url = 'https://shop.fairwaymarket.com/v3/retailers/53/module_data/aisle_%s_%s?aisle_id=%s&department_id=%s&source=web&tracking.items_per_row=7&page=%s&per=%s' % (item_brand_no,item_category_no,item_brand_no,item_category_no,next_page, per_page)
