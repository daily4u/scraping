...
class FairmarketspiderSpider(scrapy.Spider):
    ...
    def parse_goods(self, response):
        ...
        try:
            ...
            next_goods_url = 'https://shop.fairwaymarket.com/v3/retailers/53/module_data/aisle_%s_%s?aisle_id=%s&department_id=%s&source=web&tracking.items_per_row=7&page=%s&per=%s' % (depart_no,depart_sub_no,depart_no,depart_sub_no,next_page, per_page)
